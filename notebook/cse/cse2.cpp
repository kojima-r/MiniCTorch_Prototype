    ...
    void defineOp( vector<MCTNode*>& forward_result, VariableTensor &input_var )
    {
        ...
        // {'name': 'Net/17', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [16], 'constant_value': [2.0, 1.0, 0.0, 1.0, 2.0, 0.0, 1.0, 1.0, 2.0, 2.0, 2.0, 1.0, 0.0, 0.0, 2.0, 0.0], 'out': [13], 'sorted_id': 8}
        {
