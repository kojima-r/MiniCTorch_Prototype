    ...
    void do_train_loop( vector<MCTNode*>& forward_result, VariableTensor &input_var, int NL )
    {
      ...
      //int NL = 80;  // loss value
        int NB = 53;  // binary_cross_entropy
        ...
        ofstream outputfile("./vae/vae2_class.out");
    ...
    
        {
            ...
            auto y_pred = forward_result[ 48 ]->get_output();
           
            ofstream outputfile( "./vae/vae2_class.pred" );
        ...
        {
            // 40 : z output
            auto z_pred = forward_result[40]->get_output();
        
            ofstream outputfile( "./vae/vae2_class.z" );
