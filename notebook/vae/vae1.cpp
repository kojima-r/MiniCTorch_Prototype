    ...
    {
        // {'name': 'input/x', 'op': 'IO Node', 'in': [], 'output_id': 0, 'shape': [32, 64], 'out': [3, 41], 'sorted_id': 0}
        {
        ...
        // {'name': 'Net/Linear[fc2_mean]/126', 'op': 'aten::linear', 'in': [4, 5, 6], 'output_id': 0, 'shape': [32, 2], 'out': [30, 46, 9, 13], 'sorted_id': 7}
        {
        ...
        // {'name': 'Net/Linear[fc2_var]/log_var', 'op': 'aten::linear', 'in': [4, 22, 23], 'output_id': 0, 'shape': [32, 2], 'out': [49, 26, 44], 'sorted_id': 24}
        {
            Tensor::shape_type shape = {32,2};
            LinearOp* op = new LinearOp();
        ...
        // {'name': 'Net/input.9', 'op': 'aten::relu', 'in': [33], 'output_id': 0, 'shape': [32, 16], 'out': [37], 'sorted_id': 34}
        {
            Tensor::shape_type shape = {32,16};
            ReluOp* op = new ReluOp();
        ...
        // {'name': 'Net/Linear[fc4]/135', 'op': 'aten::linear', 'in': [34, 35, 36], 'output_id': 0, 'shape': [32, 64], 'out': [38], 'sorted_id': 37}
        {
            Tensor::shape_type shape = {32,64};
            LinearOp* op = new LinearOp();
        ...
        // {'name': 'Net/input', 'op': 'aten::sigmoid', 'in': [37], 'output_id': 0, 'shape': [32, 64], 'out': [41], 'sorted_id': 38}
        {
            Tensor::shape_type shape = {32,64};
        ...
        // {'name': 'Net/71', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [41], 'sorted_id': 39}
        {
            forward_result[39] = NULL;
        }
        
        // {'name': 'Net/72', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 2.0, 'out': [41], 'sorted_id': 40}
        {
            Tensor c = (fprec)2.0;
            forward_result[40] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/e1', 'op': 'aten::binary_cross_entropy', 'in': [38, 0, 39, 40], 'output_id': 0, 'shape': [], 'out': [58], 'sorted_id': 41}
        {
        ...
        // {'name': 'Net/74', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [44], 'sorted_id': 42}
        {
            Tensor c = (fprec)1.0;
        ...
        // {'name': 'Net/76', 'op': 'aten::add', 'in': [24, 42, 43], 'output_id': 0, 'shape': [32, 2], 'out': [48], 'sorted_id': 44}
        {
            Tensor::shape_type shape = {32,2};
            AddOp* op = new AddOp();
        ...
        // {'name': 'Net/77', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 2.0, 'out': [46], 'sorted_id': 45}
        {
            Tensor c = (fprec)2.0;
            forward_result[45] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/78', 'op': 'aten::pow', 'in': [7, 45], 'output_id': 0, 'shape': [32, 2], 'out': [48], 'sorted_id': 46}
        {
            Tensor::shape_type shape = {32,2};
            PowOp* op = new PowOp();
        ...
        // {'name': 'Net/79', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [48], 'sorted_id': 47}
        {
            Tensor c = (fprec)1.0;
            forward_result[47] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/80', 'op': 'aten::sub', 'in': [44, 46, 47], 'output_id': 0, 'shape': [32, 2], 'out': [51], 'sorted_id': 48}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'Net/81', 'op': 'aten::exp', 'in': [24], 'output_id': 0, 'shape': [32, 2], 'out': [51], 'sorted_id': 49}
        {
            Tensor::shape_type shape = {32,2};
            ExpOp* op = new ExpOp();
        ...
        // {'name': 'Net/82', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [51], 'sorted_id': 50}
        {
            Tensor c = (fprec)1.0;
            forward_result[50] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/g', 'op': 'aten::sub', 'in': [48, 49, 50], 'output_id': 0, 'shape': [32, 2], 'out': [53], 'sorted_id': 51}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'Net/84', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [53], 'sorted_id': 52}
        {
            forward_result[52] = NULL;
        }
        
        // {'name': 'Net/85', 'op': 'aten::sum', 'in': [51, 52], 'output_id': 0, 'shape': [], 'out': [55], 'sorted_id': 53}
        {
            SumOp*    op = new SumOp();
        ...
        // {'name': 'Net/86', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.5, 'out': [55], 'sorted_id': 54}
        {
            Tensor c = (fprec)0.5;
            forward_result[54] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/y', 'op': 'aten::mul', 'in': [53, 54], 'output_id': 0, 'shape': [], 'out': [56], 'sorted_id': 55}
        {
            MulOp* op = new MulOp();
        ...
        // {'name': 'Net/e2', 'op': 'aten::neg', 'in': [55], 'output_id': 0, 'shape': [], 'out': [58], 'sorted_id': 56}
        {
            NegOp* op = new NegOp();
        ...
        // {'name': 'Net/89', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [58], 'sorted_id': 57}
        {
            Tensor c = (fprec)1.0;
            forward_result[57] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/90', 'op': 'aten::add', 'in': [41, 56, 57], 'output_id': 0, 'shape': [], 'out': [59], 'sorted_id': 58}
        {
            AddOp* op = new AddOp();
        ...
        // {'name': 'output/output.1', 'op': 'IO Node', 'in': [58], 'output_id': 0, 'shape': [], 'out': [], 'sorted_id': 59}
        {
        }
    ...
    int main()
    {
        vector<MCTNode*> forward_result(60);
    ...
    #ifdef _TRAIN
        do_train_loop( forward_result, input_var, 58 );
    #else
        do_train1( forward_result, input_var, 58 );
    #endif
