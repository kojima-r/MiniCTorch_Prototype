    ...
    void defineOp( vector<MCTNode*>& forward_result, VariableTensor &input_var )
    {
        ...
        // {'name': 'VAE/Net[net]/loc.1', 'op': 'prim::ListUnpack', 'in': [24], 'output_id': 0, 'shape': [32, 2], 'out': [29, 49, 40, 27], 'sorted_id': 25}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/272', 'op': 'prim::TupleConstruct', 'in': [48, 25, 38], 'output_id': 0, 'shape': [], 'out': [55, 50, 54], 'sorted_id': 49}
        {
        ...
        // {'name': 'VAE/Loss[loss]/281', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [61, 79, 60, 53], 'sorted_id': 51}
        {
        ...
        // {'name': 'VAE/Loss[loss]/275', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [74, 80, 72, 76, 69], 'sorted_id': 68}
        {
            Tensor c = (fprec)1.0;
