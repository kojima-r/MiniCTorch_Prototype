    ...
    void do_train_loop( vector<MCTNode*>& forward_result, VariableTensor &input_var, int NL )
    {
        ...
        ofstream outputfile("./vae/vae.out");
        ...
        for(int epoch=0;epoch<epoch_num;epoch++)
        {
            ...
            auto o  = forward_result[NL]->output;
            auto o1 = forward_result[53]->output;
            auto o2 = forward_result[79]->output; 
            ...
            
        {
            // 48 : aten::sigmoid
            input_var.output = inp_data;
            do_forward( forward_result, 48 );
            auto y_pred = forward_result[48]->output;
            
            auto inp_shape = inp_data.shape();
            int nx = inp_shape[0];
            
            ofstream outputfile( "./vae/vae.pred" );
