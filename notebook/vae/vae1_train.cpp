    ...
    void do_train_loop( vector<MCTNode*>& forward_result, VariableTensor &input_var, int NL )
    {
      ...
      //int NL = 58;  // loss value
        int NB = 41;  // binary_cross_entropy
        int NK = 56;  // KL divergence
        ...
        ofstream outputfile("./vae/vae1.out");
    ...
    
        {
            ...
            ofstream outputfile( "./vae/vae1.pred" );
        ...
        
        {
            ...
            ofstream outputfile( "./vae/vae1.z" );
