    ...
    void defineOp( vector<MCTNode*>& forward_result, VariableTensor &input_var )
    {
        ...
        // {'name': 'Net/Linear[fc1]/input.1', 'op': 'aten::linear', 'in': [0, 1, 2], 'output_id': 0, 'shape': [63, 32], 'out': [4], 'sorted_id': 3}
        {
        ...
        // {'name': 'Net/input.3', 'op': 'aten::relu', 'in': [3], 'output_id': 0, 'shape': [63, 32], 'out': [7], 'sorted_id': 4}
        {
            Tensor::shape_type shape = {63,32};
        ...
        // {'name': 'Net/Linear[fc2]/input.5', 'op': 'aten::linear', 'in': [4, 5, 6], 'output_id': 0, 'shape': [63, 16], 'out': [8], 'sorted_id': 7}
        {
        ...
        // {'name': 'Net/input.7', 'op': 'aten::relu', 'in': [7], 'output_id': 0, 'shape': [63, 16], 'out': [11], 'sorted_id': 8}
        {
            Tensor::shape_type shape = {63,16};
            ReluOp* op = new ReluOp();
            forward_result[8] = op;
        ...
        // {'name': 'Net/Linear[fc3]/input.9', 'op': 'aten::linear', 'in': [8, 9, 10], 'output_id': 0, 'shape': [63, 1], 'out': [13], 'sorted_id': 11}
        {
            Tensor::shape_type shape = {63,1};
            LinearOp* op = new LinearOp();
        ...
        // {'name': 'Net/input', 'op': 'prim::ListUnpack', 'in': [14], 'output_id': 0, 'shape': [63, 1], 'out': [18], 'sorted_id': 15}
        {
            Tensor::shape_type shape = {63,1};
        ...
        // {'name': 'Net/target', 'op': 'prim::ListUnpack', 'in': [14], 'output_id': 1, 'shape': [63, 1], 'out': [18], 'sorted_id': 16}
        {
            Tensor::shape_type shape = {63,1};
