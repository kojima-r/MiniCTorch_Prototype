    ...
    void defineOp( vector<MCTNode*>& forward_result, VariableTensor &input_var )
    {
        ...
        // {'name': 'Net/loc.1', 'op': 'prim::ListUnpack', 'in': [15], 'output_id': 0, 'shape': [32, 2], 'out': [76, 61, 44, 18, 22], 'sorted_id': 16}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'Net/42', 'op': 'prim::NumToTensor', 'in': [18], 'output_id': 0, 'shape': [], 'out': [31, 20], 'sorted_id': 19}
        {
        ...
        // {'name': 'Net/var_ratio', 'op': 'aten::pow', 'in': [71, 72], 'output_id': 0, 'shape': [32, 2], 'out': [81, 85], 'sorted_id': 73}
        {
            Tensor::shape_type shape = {32,2};
            PowOp* op = new PowOp();
