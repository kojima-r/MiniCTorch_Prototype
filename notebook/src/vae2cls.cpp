    ...
    void defineOp( vector<MCTNode*>& forward_result, VariableTensor &input_var )
    {
        ...
        // {'name': 'VAE/Net[net]/BatchNorm1d[bn1]/214', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [13, 34, 36], 'sorted_id': 9}
        {
            Tensor c = (fprec)0.0;
            forward_result[9] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Net[net]/BatchNorm1d[bn1]/215', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.1, 'out': [13], 'sorted_id': 10}
        {
            Tensor c = (fprec)0.1;
            forward_result[10] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Net[net]/BatchNorm1d[bn1]/216', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1e-05, 'out': [13], 'sorted_id': 11}
        {
            Tensor c = (fprec)1e-05;
            forward_result[11] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Net[net]/BatchNorm1d[bn1]/217', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [13], 'sorted_id': 12}
        {
            Tensor c = (fprec)1.0;
        ...
        // {'name': 'VAE/Net[net]/Linear[fc2_mean]/weight/234', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [16], 'sorted_id': 14}
        {
        ...
        // {'name': 'VAE/Net[net]/Linear[fc2_mean]/bias/233', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [16], 'sorted_id': 15}
        {
        ...
        // {'name': 'VAE/Net[net]/Linear[fc2_mean]/235', 'op': 'aten::linear', 'in': [13, 14, 15], 'output_id': 0, 'shape': [32, 2], 'out': [23], 'sorted_id': 16}
        {
        ...
        // {'name': 'VAE/Net[net]/Linear[fc2_var]/weight/237', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [19], 'sorted_id': 17}
        {
            Tensor::shape_type shape = {2,16};
        ...
        // {'name': 'VAE/Net[net]/Linear[fc2_var]/bias/236', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [19], 'sorted_id': 18}
        {
            Tensor::shape_type shape = {2};
        ...
        // {'name': 'VAE/Net[net]/213', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.5, 'out': [21], 'sorted_id': 20}
        {
            Tensor c = (fprec)0.5;
            forward_result[20] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Net[net]/239', 'op': 'aten::mul', 'in': [19, 20], 'output_id': 0, 'shape': [32, 2], 'out': [22], 'sorted_id': 21}
        {
            Tensor::shape_type shape = {32,2};
            MulOp* op = new MulOp();
        ...
        // {'name': 'VAE/Net[net]/240', 'op': 'aten::exp', 'in': [21], 'output_id': 0, 'shape': [32, 2], 'out': [23], 'sorted_id': 22}
        {
            Tensor::shape_type shape = {32,2};
            ExpOp* op = new ExpOp();
        ...
        // {'name': 'VAE/Net[net]/241', 'op': 'prim::ListConstruct', 'in': [16, 22], 'output_id': 0, 'shape': [], 'out': [24], 'sorted_id': 23}
        {
        ...
        // {'name': 'VAE/Net[net]/242', 'op': 'aten::broadcast_tensors', 'in': [23], 'output_id': 0, 'shape': [], 'out': [38, 25], 'sorted_id': 24}
        {
        ...
        // {'name': 'VAE/Net[net]/loc.1', 'op': 'prim::ListUnpack', 'in': [24], 'output_id': 0, 'shape': [32, 2], 'out': [49, 40, 27, 29], 'sorted_id': 25}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/Net[net]/212', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [27], 'sorted_id': 26}
        {
            Tensor c = (fprec)0.0;
            forward_result[26] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Net[net]/245', 'op': 'aten::size', 'in': [25, 26], 'output_id': 0, 'shape': [], 'out': [30, 35], 'sorted_id': 27}
        {
        ...
        // {'name': 'VAE/Net[net]/211', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [40, 29], 'sorted_id': 28}
        {
            Tensor c = (fprec)1.0;
            forward_result[28] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Net[net]/246', 'op': 'aten::size', 'in': [25, 28], 'output_id': 0, 'shape': [], 'out': [30, 35], 'sorted_id': 29}
        {
            SizeOp* op = new SizeOp();
        ...
        // {'name': 'VAE/Net[net]/247', 'op': 'prim::ListConstruct', 'in': [27, 29], 'output_id': 0, 'shape': [], 'out': [34], 'sorted_id': 30}
        {
            ListConstructOp* op = new ListConstructOp();
        ...
        // {'name': 'VAE/Net[net]/210', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 6.0, 'out': [34, 36], 'sorted_id': 31}
        {
            Tensor c = (fprec)6.0;
            forward_result[31] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Net[net]/209', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [34, 36, 37], 'sorted_id': 32}
        {
            forward_result[32] = NULL;
        }
        
        // {'name': 'VAE/Net[net]/208', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [34, 36], 'sorted_id': 33}
        {
            forward_result[33] = NULL;
        }
        
        // {'name': 'VAE/Net[net]/248', 'op': 'aten::zeros', 'in': [30, 31, 32, 33, 9], 'output_id': 0, 'shape': [32, 2], 'out': [37], 'sorted_id': 34}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/Net[net]/249', 'op': 'prim::ListConstruct', 'in': [27, 29], 'output_id': 0, 'shape': [], 'out': [36], 'sorted_id': 35}
        {
            ListConstructOp* op = new ListConstructOp();
        ...
        // {'name': 'VAE/Net[net]/250', 'op': 'aten::ones', 'in': [35, 31, 32, 33, 9], 'output_id': 0, 'shape': [32, 2], 'out': [37], 'sorted_id': 36}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/Net[net]/252', 'op': 'aten::mul', 'in': [37, 38], 'output_id': 0, 'shape': [32, 2], 'out': [40], 'sorted_id': 39}
        {
            Tensor::shape_type shape = {32,2};
            MulOp* op = new MulOp();
        ...
        // {'name': 'VAE/Net[net]/Linear[fc3]/weight/255', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [43], 'sorted_id': 41}
        {
        ...
        // {'name': 'VAE/Net[net]/Linear[fc3]/bias/254', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [43], 'sorted_id': 42}
        {
            Tensor::shape_type shape = {16};
        ...
        // {'name': 'VAE/Net[net]/Linear[fc4]/weight/259', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [47], 'sorted_id': 45}
        {
        ...
        // {'name': 'VAE/Net[net]/Linear[fc4]/bias/258', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [47], 'sorted_id': 46}
        {
        ...
        // {'name': 'VAE/Net[net]/Linear[fc4]/260', 'op': 'aten::linear', 'in': [44, 45, 46], 'output_id': 0, 'shape': [32, 64], 'out': [48], 'sorted_id': 47}
        {
            Tensor::shape_type shape = {32,64};
            LinearOp* op = new LinearOp();
        ...
        // {'name': 'VAE/262', 'op': 'prim::TupleConstruct', 'in': [48, 25, 38], 'output_id': 0, 'shape': [], 'out': [54, 50, 55], 'sorted_id': 49}
        {
        ...
        // {'name': 'VAE/203', 'op': 'prim::TupleUnpack', 'in': [49], 'output_id': 0, 'shape': [32, 64], 'out': [53], 'sorted_id': 50}
        {
            Tensor::shape_type shape = {32,64};
        ...
        // {'name': 'VAE/Loss[loss]/271', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [79, 61, 53, 60], 'sorted_id': 51}
        {
            forward_result[51] = NULL;
        }
        
        // {'name': 'VAE/Loss[loss]/270', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [76, 80, 74, 69, 72, 53], 'sorted_id': 52}
        {
            Tensor c = (fprec)1.0;
        ...
        // {'name': 'VAE/205', 'op': 'prim::TupleUnpack', 'in': [49], 'output_id': 2, 'shape': [32, 2], 'out': [61, 65], 'sorted_id': 54}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/204', 'op': 'prim::TupleUnpack', 'in': [49], 'output_id': 1, 'shape': [32, 2], 'out': [69, 60], 'sorted_id': 55}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/Loss[loss]/269', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 6.0, 'out': [61, 60], 'sorted_id': 56}
        {
            Tensor c = (fprec)6.0;
            forward_result[56] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Loss[loss]/268', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [61, 60], 'sorted_id': 57}
        {
            Tensor c = (fprec)0.0;
            forward_result[57] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Loss[loss]/267', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [61, 60], 'sorted_id': 58}
        {
            forward_result[58] = NULL;
        }
        
        // {'name': 'VAE/Loss[loss]/266', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [61, 60], 'sorted_id': 59}
        {
            Tensor c = (fprec)0.0;
            forward_result[59] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Loss[loss]/273', 'op': 'aten::zeros_like', 'in': [55, 56, 57, 58, 59, 51], 'output_id': 0, 'shape': [32, 2], 'out': [62], 'sorted_id': 60}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/Loss[loss]/274', 'op': 'aten::ones_like', 'in': [54, 56, 57, 58, 59, 51], 'output_id': 0, 'shape': [32, 2], 'out': [62], 'sorted_id': 61}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'VAE/Loss[loss]/275', 'op': 'prim::ListConstruct', 'in': [60, 61], 'output_id': 0, 'shape': [], 'out': [63], 'sorted_id': 62}
        {
            ListConstructOp* op = new ListConstructOp();
        ...
        // {'name': 'VAE/Loss[loss]/276', 'op': 'aten::broadcast_tensors', 'in': [62], 'output_id': 0, 'shape': [], 'out': [64, 68], 'sorted_id': 63}
        {
            BroadcastTensorsOp* op = new BroadcastTensorsOp();
        ...
        // {'name': 'VAE/Loss[loss]/279', 'op': 'aten::div', 'in': [54, 64], 'output_id': 0, 'shape': [32, 2], 'out': [67], 'sorted_id': 65}
        {
            Tensor::shape_type shape = {32,2};
            DivOp* op = new DivOp();
        ...
        // {'name': 'VAE/Loss[loss]/265', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 2.0, 'out': [67, 71], 'sorted_id': 66}
        {
            Tensor c = (fprec)2.0;
            forward_result[66] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Loss[loss]/var_ratio', 'op': 'aten::pow', 'in': [65, 66], 'output_id': 0, 'shape': [32, 2], 'out': [72, 75], 'sorted_id': 67}
        {
            Tensor::shape_type shape = {32,2};
            PowOp* op = new PowOp();
        ...
        // {'name': 'VAE/Loss[loss]/loc', 'op': 'prim::ListUnpack', 'in': [63], 'output_id': 0, 'shape': [32, 2], 'out': [69], 'sorted_id': 68}
        {
            Tensor::shape_type shape = {32,2};
            ListUnpackOp* op = new ListUnpackOp( 0 );
        ...
        // {'name': 'VAE/Loss[loss]/281', 'op': 'aten::sub', 'in': [55, 68, 52], 'output_id': 0, 'shape': [32, 2], 'out': [70], 'sorted_id': 69}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'VAE/Loss[loss]/282', 'op': 'aten::div', 'in': [69, 64], 'output_id': 0, 'shape': [32, 2], 'out': [71], 'sorted_id': 70}
        {
            Tensor::shape_type shape = {32,2};
            DivOp* op = new DivOp();
        ...
        // {'name': 'VAE/Loss[loss]/t1', 'op': 'aten::pow', 'in': [70, 66], 'output_id': 0, 'shape': [32, 2], 'out': [72], 'sorted_id': 71}
        {
            Tensor::shape_type shape = {32,2};
            PowOp* op = new PowOp();
        ...
        // {'name': 'VAE/Loss[loss]/284', 'op': 'aten::add', 'in': [67, 71, 52], 'output_id': 0, 'shape': [32, 2], 'out': [74], 'sorted_id': 72}
        {
            Tensor::shape_type shape = {32,2};
            AddOp* op = new AddOp();
        ...
        // {'name': 'VAE/Loss[loss]/264', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [74], 'sorted_id': 73}
        {
            Tensor c = (fprec)1.0;
            forward_result[73] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Loss[loss]/285', 'op': 'aten::sub', 'in': [72, 73, 52], 'output_id': 0, 'shape': [32, 2], 'out': [76], 'sorted_id': 74}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'VAE/Loss[loss]/286', 'op': 'aten::log', 'in': [67], 'output_id': 0, 'shape': [32, 2], 'out': [76], 'sorted_id': 75}
        {
            Tensor::shape_type shape = {32,2};
            LogOp* op = new LogOp();
        ...
        // {'name': 'VAE/Loss[loss]/287', 'op': 'aten::sub', 'in': [74, 75, 52], 'output_id': 0, 'shape': [32, 2], 'out': [78], 'sorted_id': 76}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'VAE/Loss[loss]/263', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.5, 'out': [78], 'sorted_id': 77}
        {
            Tensor c = (fprec)0.5;
            forward_result[77] = new VariableTensor( c, false );
        }
        
        // {'name': 'VAE/Loss[loss]/288', 'op': 'aten::mul', 'in': [76, 77], 'output_id': 0, 'shape': [32, 2], 'out': [79], 'sorted_id': 78}
        {
            Tensor::shape_type shape = {32,2};
            MulOp* op = new MulOp();
        ...
        // {'name': 'VAE/Loss[loss]/290', 'op': 'aten::add', 'in': [53, 79, 52], 'output_id': 0, 'shape': [], 'out': [81], 'sorted_id': 80}
        {
            AddOp* op = new AddOp();
