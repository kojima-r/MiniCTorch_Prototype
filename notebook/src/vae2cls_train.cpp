    ...
    void do_train_loop( vector<MCTNode*>& forward_result, VariableTensor &input_var, int NL )
    {
        ...
        fprec lr = 0.01;
        /* without batchnorm
      //int   NL =  72;  // loss value
        int   NZ =  32;  // latent value
        int   NS =  40;  // sigmoid
        int   NB =  45;  // binary cross entropy
        int   NK =  71;  // KL divergence*/
        // with batchnorm
      //int   NL =  80;  // loss value
        int   NZ =  40;  // latent value
        int   NS =  48;  // sigmoid
        int   NB =  53;  // binary cross entropy
        int   NK =  79;  // KL divergence
