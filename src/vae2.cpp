    ...
    int main()
    {
        ...
        // {'name': 'input/x', 'op': 'IO Node', 'in': [], 'output_id': 0, 'shape': [32, 64], 'out': [3, 55], 'sorted_id': 0}
        {
            Tensor::shape_type shape = {32,64};
        ...
        // {'name': 'Net/Linear[fc2_mean]/266', 'op': 'aten::linear', 'in': [4, 5, 6], 'output_id': 0, 'shape': [32, 2], 'out': [14], 'sorted_id': 7}
        {
        ...
        // {'name': 'Net/Linear[fc2_var]/269', 'op': 'aten::linear', 'in': [4, 8, 9], 'output_id': 0, 'shape': [32, 2], 'out': [12], 'sorted_id': 10}
        {
            Tensor::shape_type shape = {32,2};
            LinearOp* op = new LinearOp();
        ...
        // {'name': 'Net/36', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.5, 'out': [12], 'sorted_id': 11}
        {
            Tensor c = (fprec)0.5;
            forward_result[11] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/37', 'op': 'aten::mul', 'in': [10, 11], 'output_id': 0, 'shape': [32, 2], 'out': [13], 'sorted_id': 12}
        {
            Tensor::shape_type shape = {32,2};
            MulOp* op = new MulOp();
        ...
        // {'name': 'Net/38', 'op': 'aten::exp', 'in': [12], 'output_id': 0, 'shape': [32, 2], 'out': [14], 'sorted_id': 13}
        {
            Tensor::shape_type shape = {32,2};
            ExpOp* op = new ExpOp();
        ...
        // {'name': 'Net/39', 'op': 'prim::ListConstruct', 'in': [7, 13], 'output_id': 0, 'shape': [], 'out': [15], 'sorted_id': 14}
        {
        ...
        // {'name': 'Net/40', 'op': 'aten::broadcast_tensors', 'in': [14], 'output_id': 0, 'shape': [], 'out': [16, 41], 'sorted_id': 15}
        {
        ...
        // {'name': 'Net/loc.1', 'op': 'prim::ListUnpack', 'in': [15], 'output_id': 0, 'shape': [32, 2], 'out': [61, 22, 76, 18, 44], 'sorted_id': 16}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'Net/43', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [18], 'sorted_id': 17}
        {
            Tensor c = (fprec)0.0;
            forward_result[17] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/44', 'op': 'aten::size', 'in': [16, 17], 'output_id': 0, 'shape': [], 'out': [19], 'sorted_id': 18}
        {
        ...
        // {'name': 'Net/45', 'op': 'prim::NumToTensor', 'in': [18], 'output_id': 0, 'shape': [], 'out': [20, 31], 'sorted_id': 19}
        {
        ...
        // {'name': 'Net/54', 'op': 'aten::Int', 'in': [19], 'output_id': 0, 'shape': [], 'out': [25], 'sorted_id': 20}
        {
        ...
        // {'name': 'Net/46', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [22], 'sorted_id': 21}
        {
            Tensor c = (fprec)1.0;
            forward_result[21] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/47', 'op': 'aten::size', 'in': [16, 21], 'output_id': 0, 'shape': [], 'out': [23], 'sorted_id': 22}
        {
            SizeOp* op = new SizeOp();
        ...
        // {'name': 'Net/48', 'op': 'prim::NumToTensor', 'in': [22], 'output_id': 0, 'shape': [], 'out': [32, 24], 'sorted_id': 23}
        {
            MoveOp* op = new MoveOp( "NumToTensor" );
        ...
        // {'name': 'Net/55', 'op': 'aten::Int', 'in': [23], 'output_id': 0, 'shape': [], 'out': [25], 'sorted_id': 24}
        {
            MoveOp* op = new MoveOp( "Int" );
        ...
        // {'name': 'Net/56', 'op': 'prim::ListConstruct', 'in': [20, 24], 'output_id': 0, 'shape': [], 'out': [30], 'sorted_id': 25}
        {
            ListConstructOp* op = new ListConstructOp();
        ...
        // {'name': 'Net/57', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 6.0, 'out': [30], 'sorted_id': 26}
        {
            Tensor c = (fprec)6.0;
            forward_result[26] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/58', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [30], 'sorted_id': 27}
        {
            forward_result[27] = NULL;
        }
        
        // {'name': 'Net/59', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [30], 'sorted_id': 28}
        {
            forward_result[28] = NULL;
        }
        
        // {'name': 'Net/60', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [30], 'sorted_id': 29}
        {
            Tensor c = (fprec)0.0;
            forward_result[29] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/61', 'op': 'aten::zeros', 'in': [25, 26, 27, 28, 29], 'output_id': 0, 'shape': [32, 2], 'out': [40], 'sorted_id': 30}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'Net/62', 'op': 'aten::Int', 'in': [19], 'output_id': 0, 'shape': [], 'out': [33], 'sorted_id': 31}
        {
            MoveOp* op = new MoveOp( "Int" );
        ...
        // {'name': 'Net/63', 'op': 'aten::Int', 'in': [23], 'output_id': 0, 'shape': [], 'out': [33], 'sorted_id': 32}
        {
            MoveOp* op = new MoveOp( "Int" );
        ...
        // {'name': 'Net/64', 'op': 'prim::ListConstruct', 'in': [31, 32], 'output_id': 0, 'shape': [], 'out': [38], 'sorted_id': 33}
        {
            ListConstructOp* op = new ListConstructOp();
        ...
        // {'name': 'Net/65', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 6.0, 'out': [38], 'sorted_id': 34}
        {
            Tensor c = (fprec)6.0;
            forward_result[34] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/66', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [38], 'sorted_id': 35}
        {
            forward_result[35] = NULL;
        }
        
        // {'name': 'Net/67', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [38], 'sorted_id': 36}
        {
            forward_result[36] = NULL;
        }
        
        // {'name': 'Net/68', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [38], 'sorted_id': 37}
        {
            Tensor c = (fprec)0.0;
            forward_result[37] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/69', 'op': 'aten::ones', 'in': [33, 34, 35, 36, 37], 'output_id': 0, 'shape': [32, 2], 'out': [40], 'sorted_id': 38}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'Net/70', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [40], 'sorted_id': 39}
        {
        ...
        // {'name': 'Net/value.1', 'op': 'prim::ListUnpack', 'in': [15], 'output_id': 1, 'shape': [32, 2], 'out': [67, 42, 71], 'sorted_id': 41}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'Net/72', 'op': 'aten::mul', 'in': [40, 41], 'output_id': 0, 'shape': [32, 2], 'out': [44], 'sorted_id': 42}
        {
            Tensor::shape_type shape = {32,2};
            MulOp* op = new MulOp();
        ...
        // {'name': 'Net/73', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [44], 'sorted_id': 43}
        {
            Tensor c = (fprec)1.0;
        ...
        // {'name': 'Net/Linear[fc3]/bias/270', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [47], 'sorted_id': 46}
        {
            Tensor::shape_type shape = {16};
        ...
        // {'name': 'Net/Linear[fc4]/weight/274', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [51], 'sorted_id': 49}
        {
        ...
        // {'name': 'Net/Linear[fc4]/bias/273', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [51], 'sorted_id': 50}
        {
            Tensor::shape_type shape = {64};
            forward_result[50] = new VariableTensor(fc4_bias);
        }
        
        // {'name': 'Net/Linear[fc4]/275', 'op': 'aten::linear', 'in': [48, 49, 50], 'output_id': 0, 'shape': [32, 64], 'out': [52], 'sorted_id': 51}
        {
            Tensor::shape_type shape = {32,64};
            LinearOp* op = new LinearOp();
        ...
        // {'name': 'Net/BCELoss[bce1]/277', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [55], 'sorted_id': 53}
        {
            forward_result[53] = NULL;
        }
        
        // {'name': 'Net/BCELoss[bce1]/276', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [55], 'sorted_id': 54}
        {
            Tensor c = (fprec)1.0;
            forward_result[54] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/BCELoss[bce1]/tensor.1', 'op': 'aten::binary_cross_entropy', 'in': [52, 0, 53, 54], 'output_id': 0, 'shape': [], 'out': [93], 'sorted_id': 55}
        {
        ...
        // {'name': 'Net/96', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 6.0, 'out': [61], 'sorted_id': 56}
        {
            Tensor c = (fprec)6.0;
            forward_result[56] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/97', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [61], 'sorted_id': 57}
        {
            Tensor c = (fprec)0.0;
            forward_result[57] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/98', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [61], 'sorted_id': 58}
        {
            forward_result[58] = NULL;
        }
        
        // {'name': 'Net/99', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [61], 'sorted_id': 59}
        {
            Tensor c = (fprec)0.0;
            forward_result[59] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/100', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [61], 'sorted_id': 60}
        {
            forward_result[60] = NULL;
        }
        
        // {'name': 'Net/101', 'op': 'aten::zeros_like', 'in': [16, 56, 57, 58, 59, 60], 'output_id': 0, 'shape': [32, 2], 'out': [68], 'sorted_id': 61}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'Net/102', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 6.0, 'out': [67], 'sorted_id': 62}
        {
            Tensor c = (fprec)6.0;
            forward_result[62] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/103', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [67], 'sorted_id': 63}
        {
            Tensor c = (fprec)0.0;
            forward_result[63] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/104', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [67], 'sorted_id': 64}
        {
            forward_result[64] = NULL;
        }
        
        // {'name': 'Net/105', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.0, 'out': [67], 'sorted_id': 65}
        {
            Tensor c = (fprec)0.0;
            forward_result[65] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/106', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [67], 'sorted_id': 66}
        {
            forward_result[66] = NULL;
        }
        
        // {'name': 'Net/107', 'op': 'aten::ones_like', 'in': [41, 62, 63, 64, 65, 66], 'output_id': 0, 'shape': [32, 2], 'out': [68], 'sorted_id': 67}
        {
            Tensor::shape_type shape = {32,2};
        ...
        // {'name': 'Net/108', 'op': 'prim::ListConstruct', 'in': [61, 67], 'output_id': 0, 'shape': [], 'out': [69], 'sorted_id': 68}
        {
            ListConstructOp* op = new ListConstructOp();
        ...
        // {'name': 'Net/109', 'op': 'aten::broadcast_tensors', 'in': [68], 'output_id': 0, 'shape': [], 'out': [74, 70], 'sorted_id': 69}
        {
            BroadcastTensorsOp* op = new BroadcastTensorsOp();
        ...
        // {'name': 'Net/value.3', 'op': 'prim::ListUnpack', 'in': [69], 'output_id': 1, 'shape': [32, 2], 'out': [77, 71], 'sorted_id': 70}
        {
            Tensor::shape_type shape = {32,2};
            ListUnpackOp* op = new ListUnpackOp( 1 );
        ...
        // {'name': 'Net/123', 'op': 'aten::div', 'in': [41, 70], 'output_id': 0, 'shape': [32, 2], 'out': [73], 'sorted_id': 71}
        {
            Tensor::shape_type shape = {32,2};
            DivOp* op = new DivOp();
        ...
        // {'name': 'Net/124', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 2.0, 'out': [73], 'sorted_id': 72}
        {
            Tensor c = (fprec)2.0;
        ...
        // {'name': 'Net/126', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [76], 'sorted_id': 75}
        {
            Tensor c = (fprec)1.0;
            forward_result[75] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/127', 'op': 'aten::sub', 'in': [16, 74, 75], 'output_id': 0, 'shape': [32, 2], 'out': [77], 'sorted_id': 76}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'Net/128', 'op': 'aten::div', 'in': [76, 70], 'output_id': 0, 'shape': [32, 2], 'out': [79], 'sorted_id': 77}
        {
            Tensor::shape_type shape = {32,2};
            DivOp* op = new DivOp();
        ...
        // {'name': 'Net/129', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 2.0, 'out': [79], 'sorted_id': 78}
        {
            Tensor c = (fprec)2.0;
        ...
        // {'name': 'Net/131', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [81], 'sorted_id': 80}
        {
            Tensor c = (fprec)1.0;
            forward_result[80] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/132', 'op': 'aten::add', 'in': [73, 79, 80], 'output_id': 0, 'shape': [32, 2], 'out': [84], 'sorted_id': 81}
        {
            Tensor::shape_type shape = {32,2};
            AddOp* op = new AddOp();
        ...
        // {'name': 'Net/133', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [84], 'sorted_id': 82}
        {
            Tensor c = (fprec)1.0;
            forward_result[82] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/134', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [84], 'sorted_id': 83}
        {
            Tensor c = (fprec)1.0;
            forward_result[83] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/135', 'op': 'aten::sub', 'in': [81, 82, 83], 'output_id': 0, 'shape': [32, 2], 'out': [87], 'sorted_id': 84}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'Net/136', 'op': 'aten::log', 'in': [73], 'output_id': 0, 'shape': [32, 2], 'out': [87], 'sorted_id': 85}
        {
            Tensor::shape_type shape = {32,2};
            LogOp* op = new LogOp();
        ...
        // {'name': 'Net/137', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [87], 'sorted_id': 86}
        {
            Tensor c = (fprec)1.0;
            forward_result[86] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/138', 'op': 'aten::sub', 'in': [84, 85, 86], 'output_id': 0, 'shape': [32, 2], 'out': [89], 'sorted_id': 87}
        {
            Tensor::shape_type shape = {32,2};
            SubOp* op = new SubOp();
        ...
        // {'name': 'Net/139', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 0.5, 'out': [89], 'sorted_id': 88}
        {
            Tensor c = (fprec)0.5;
            forward_result[88] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/140', 'op': 'aten::mul', 'in': [87, 88], 'output_id': 0, 'shape': [32, 2], 'out': [91], 'sorted_id': 89}
        {
            Tensor::shape_type shape = {32,2};
            MulOp* op = new MulOp();
        ...
        // {'name': 'Net/141', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'out': [91], 'sorted_id': 90}
        {
            forward_result[90] = NULL;
        }
        
        // {'name': 'Net/tensor', 'op': 'aten::sum', 'in': [89, 90], 'output_id': 0, 'shape': [], 'out': [93], 'sorted_id': 91}
        {
            SumOp*    op = new SumOp();
        ...
        // {'name': 'Net/225', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [93], 'sorted_id': 92}
        {
            Tensor c = (fprec)1.0;
            forward_result[92] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/226', 'op': 'aten::add', 'in': [55, 91, 92], 'output_id': 0, 'shape': [], 'out': [94], 'sorted_id': 93}
        {
            AddOp* op = new AddOp();
        ...
        cout<<"e1"<<forward_result[55]->output<<endl;
        cout<<"e2"<<forward_result[91]->output<<endl;
