    ...
    int main()
    {
        ...
        // {'name': 'Net/Linear[fc1]/weight/64', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [3], 'sorted_id': 1}
        {
        ...
        // {'name': 'Net/input.3', 'op': 'aten::relu', 'in': [3], 'output_id': 0, 'shape': [100, 64], 'out': [7], 'sorted_id': 4}
        {
            Tensor::shape_type shape = {100,64};
        ...
        // {'name': 'Net/Linear[fc2]/weight/67', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [7], 'sorted_id': 5}
        {
        ...
        // {'name': 'Net/input.7', 'op': 'aten::relu', 'in': [7], 'output_id': 0, 'shape': [100, 32], 'out': [11], 'sorted_id': 8}
        {
            Tensor::shape_type shape = {100,32};
            ReluOp* op = new ReluOp();
            forward_result[8] = op;
        ...
        // {'name': 'Net/Linear[fc3]/weight/70', 'op': 'prim::GetAttr', 'in': [], 'output_id': 0, 'shape': [], 'out': [11], 'sorted_id': 9}
        {
        ...
        // {'name': 'Net/39', 'op': 'prim::ListConstruct', 'in': [11, 12], 'output_id': 0, 'shape': [], 'out': [14], 'sorted_id': 13}
        {
        ...
        // {'name': 'Net/40', 'op': 'aten::broadcast_tensors', 'in': [13], 'output_id': 0, 'shape': [], 'out': [15, 16], 'sorted_id': 14}
        {
        ...
        // {'name': 'Net/input', 'op': 'prim::ListUnpack', 'in': [14], 'output_id': 0, 'shape': [100, 1], 'out': [18], 'sorted_id': 15}
        {
            Tensor::shape_type shape = {100,1};
        ...
        // {'name': 'Net/target', 'op': 'prim::ListUnpack', 'in': [14], 'output_id': 1, 'shape': [100, 1], 'out': [18], 'sorted_id': 16}
        {
            Tensor::shape_type shape = {100,1};
        ...
        // {'name': 'Net/43', 'op': 'prim::Constant', 'in': [], 'output_id': 0, 'shape': [], 'constant_value': 1.0, 'out': [18], 'sorted_id': 17}
        {
            Tensor c = (fprec)1.0;
            forward_result[17] = new VariableTensor( c, false );
        }
        
        // {'name': 'Net/44', 'op': 'aten::mse_loss', 'in': [15, 16, 17], 'output_id': 0, 'shape': [], 'out': [19], 'sorted_id': 18}
        {
    ...
    
    {
       ...
       exec_forward( forward_result, NS );
